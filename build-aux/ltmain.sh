...
# Test whether ${var%pattern} ${var%%pattern} ${var#pattern} ${var##pattern}
# are supported.
if (foo=abc; test "${foo%b*}" = a) 2>/dev/null; then
  have_expansion_with_removal=:
else
  have_expansion_with_removal=false
fi
